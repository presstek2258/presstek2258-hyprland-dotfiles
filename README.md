...
1. use `lsblk -f` to check mounting and location: `/dev/sda2`
2. mount the partition to `/mnt/FireLinux` with `BTRFS` format, by adding the following line to `/etc/fstab`  
